...
export default function ProfilePanel({ isOpen, onClose, user, onLogout }) {
  return (
    <>
        ...
        {user ? (
          <>
            ...
            <button
              ...
              onClick={onLogout}
              style={{ width: '100%', background: 'none', border: 'none', cursor: 'pointer', color: '#dc2626', textAlign: 'left' }}
            >
              <span className="panel-item-icon">
          ...
          <a href="/contact" className="panel-item panel-item--muted">
            <span className="panel-item-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg>
            </span>
            Nous contacter
