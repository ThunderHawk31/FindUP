  ...
  steps: [
    {
      ...
      free: true,
      tools: [
        { label: 'Joint torique', href: 'https://www.leroymerlin.fr/recherche/joint+torique/', icon: 'ring' },
        { label: 'Ruban PTFE', href: 'https://www.leroymerlin.fr/recherche/ruban+ptfe/', icon: 'roll' },
        { label: 'Pince multiprise', href: 'https://www.leroymerlin.fr/recherche/pince+multiprise/', icon: 'tool' },
      ],
    },
    {
      num: 2,
      ...
      free: true,
      tools: [
        { label: 'Seau de chantier', href: 'https://www.leroymerlin.fr/recherche/seau+chantier/', icon: 'bucket' },
        { label: 'Chiffons absorbants', href: 'https://www.leroymerlin.fr/recherche/chiffon+absorbant/', icon: 'cloth' },
      ],
    },
    {
      num: 3,
      ...
      free: true,
      tools: [
        { label: 'Siphon de remplacement', href: 'https://www.leroymerlin.fr/recherche/siphon+evier/', icon: 'pipe' },
      ],
    },
    {
      num: 4,
      ...
      tools: [
        { label: 'Joint torique', href: 'https://www.leroymerlin.fr/recherche/joint+torique/', icon: 'ring' },
        { label: 'Graisse silicone', href: 'https://www.leroymerlin.fr/recherche/graisse+silicone/', icon: 'grease' },
      ],
    },
    {
      num: 5,
...
/* ── Barre d'outils par étape ── */
function StepTools({ tools }) {
  if (!tools || tools.length === 0) return null
  return (
    <div className="step-tools">
      <span className="step-tools-label">Acheter le matériel</span>
      <div className="step-tools-list">
        {tools.map((tool, i) => (
          <a
            ...
            className="step-tool-chip"
            style={{ '--chip-delay': `${i * 0.06}s` }}
          >
            <span className="step-tool-chip-label">{tool.label}</span>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" width="10" height="10" className="step-tool-chip-arrow">
  ...
  return (
    <div className={`guide-step${visible ? ' guide-step--visible' : ''}`} style={{ '--step-delay': `${index * 0.07}s` }}>
      ...
      <div className="guide-step-body">
        ...
        {/* Liens outils — apparaissent avec la carte */}
        <StepTools tools={step.tools} />
                ...
                <div className="guide-paywall">
                  <div className="guide-ios-sheet">
                    ...
                    <div className="guide-ios-price-row">
                      ...
                      <span className="guide-ios-price-label">accès 3 mois</span>
                    </div>
